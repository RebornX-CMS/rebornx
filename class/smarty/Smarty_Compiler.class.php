...
class Smarty_Compiler extends Smarty {
	 ...
	 */
    public function _compile_file($tpl_file, $template_source, &$template_compiled)
    {
        if ($this->security) {
	 ...
	 * @param string $tag_modifier
	 */
    public function _compile_custom_tag($tag_command, $tag_args, $tag_modifier)
    {
	 ...
	 * @param string $tag_args
	 */
    public function _compile_config_load_tag($tag_args)
    {
        $attrs = $this->_parse_attrs($tag_args);
	 ...
	 */
    public function _parse_attrs($tag_args, $quote = true)
    {
	 ...
	 */
    public function _parse_var_props($val, $tag_attrs = null)
    {					
